# Pizza Management System Computer Software

### 1)Description

The "Pizza Management System" has been developed to address the issues prevalent in the manual system. This software is designed to eliminate and in some cases reduce the hardships faced by this existing system. Moreover, this system is designed for the particular need of the establishment to carry out operations smoothly and effectively.
